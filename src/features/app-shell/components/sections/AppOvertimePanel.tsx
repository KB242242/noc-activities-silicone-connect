  ...
  return (
    <motion.div key="overtime" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold">Heures supplementaires</h1>
          <p className="text-muted-foreground">2h automatiques par jour travaille</p>
        </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <Card className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">Jours travailles</span>
                </div>
              ...
              <Card className="p-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-muted-foreground">Approuve par</span>
                </div>
            ...
            <Card>
              <CardHeader className="pb-2 pt-4">
                <div className="flex items-center justify-between">
                  <CardTitle className="text-base">Detail mensuel</CardTitle>
                  ...
                  <table className="w-full text-sm">
                    <thead className="sticky top-0 bg-background">
                      <tr className="border-b">
                        ...
                        <th className="text-left p-2 font-medium">Duree</th>
                      </tr>
                    </thead>
                    <tbody>
