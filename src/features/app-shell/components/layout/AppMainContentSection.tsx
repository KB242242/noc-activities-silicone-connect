...
import { AppEditTicketDialogSection } from '@/features/app-shell/components/tickets/dialogs/AppEditTicketDialogSection';
import { AppEmailTabSection } from '@/features/app-shell/components/email/AppEmailTabSection';
import { AppLinksPanel } from '@/features/app-shell/components/sections/AppLinksPanel';
...
import { AppOvertimePanel } from '@/features/app-shell/components/sections/AppOvertimePanel';
import { AppPlanningPanel } from '@/features/app-shell/components/sections/AppPlanningPanel';
...
export function AppMainContentSection(props: AppMainContentSectionProps) {
  ...
  return (
    <>
      ...
      {currentTab === 'links' && <AppLinksPanel key="tab-links" />}

      {currentTab === 'email' && <AppEmailTabSection key="tab-email" {...props} />}
