...
import type { TicketCountryOption, TicketLocalityDraft, TicketManagedLocality } from '@/features/app-shell/core/shared/types';
        ...
        <Tabs value={quickLocalityTab} onValueChange={(value) => onQuickLocalityTabChange(value as 'create' | 'manage')}>
          ...
          <TabsContent value="manage" className="space-y-3 py-2 mt-3">
            ...
            <div className="flex flex-wrap gap-2 pt-2">
              <Button onClick={() => void onUpdateManagedLocality()} disabled={isUpdatingLocality}>
                {isUpdatingLocality ? 'Mise à jour...' : 'Mettre à jour'}
              </Button>
              <Button variant="destructive" onClick={() => void onDeleteManagedLocality()} disabled={isDeletingLocality}>
