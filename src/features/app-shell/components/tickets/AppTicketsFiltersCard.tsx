      ...
      <CardContent>
        <div className="flex flex-wrap gap-3">
          ...
          <Select value={statusFilter} onValueChange={onStatusFilterChange}>
            <SelectTrigger className="w-35 border-2 dark:border-slate-600 dark:bg-slate-800"><SelectValue placeholder="Statut" /></SelectTrigger>
          ...
          <Select value={priorityFilter} onValueChange={onPriorityFilterChange}>
            <SelectTrigger className="w-35 border-2 dark:border-slate-600 dark:bg-slate-800"><SelectValue placeholder="Priorité" /></SelectTrigger>
            <SelectContent className="bg-white dark:bg-slate-800">
          ...
          <Select value={siteFilter} onValueChange={onSiteFilterChange}>
            <SelectTrigger className="w-35 border-2 dark:border-slate-600 dark:bg-slate-800"><SelectValue placeholder="Site" /></SelectTrigger>
            <SelectContent className="bg-white dark:bg-slate-800">
          ...
          <Select value={localityFilter} onValueChange={onLocalityFilterChange}>
            <SelectTrigger className="w-35 border-2 dark:border-slate-600 dark:bg-slate-800"><SelectValue placeholder="Localité" /></SelectTrigger>
            <SelectContent className="bg-white dark:bg-slate-800">
          ...
          <Select value={technicianFilter} onValueChange={onTechnicianFilterChange}>
            <SelectTrigger className="w-45 border-2 dark:border-slate-600 dark:bg-slate-800"><SelectValue placeholder="Technicien" /></SelectTrigger>
            <SelectContent className="bg-white dark:bg-slate-800">
